...
class MobileNumber(Base):
    ...
    # These two fields have been used to make versions 05a and 05b to test multiple heads
    # 05a
    # is_mobile: Mapped[bool] = Column(Boolean, nullable=False, default=True)
    # 05b
    # is_landline: Mapped[bool] = Column(Boolean, nullable=False, default=True)
